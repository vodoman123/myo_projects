scriptId = 'com.thalmic.examples.presentation'
scriptTitle = "PowerPoint Connector"
scriptDetailsUrl = "https://market.myo.com/app/5474c658e4b0361138df2a9e"

function onForegroundWindowChange(app, title)
	return platform == "MacOS" and app == "com.microsoft.Powerpoint" or platform == "Windows" and (app == "POWERPNT.EXE" or app == "PPTVIEW.EXE")
end
...
--Helpers
function conditionalSwapWave(pose)
